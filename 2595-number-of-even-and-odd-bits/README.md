...
<p>Let <code>even</code> <span class="highlighter highlight-on">denote</span> the number of even indices in the binary representation of <code>n</code> (<strong>0-indexed</strong>) with value <code>1</code>.</p>

<p>Let <code>odd</code> <span class="highlighter highlight-on">denote</span> the number of odd indices in the binary representation of <code>n</code> (<strong>0-indexed</strong>) with value <code>1</code>.</p>
